...
/**
 * Este 'handler' es el encargado de forwardear la información a través de los
 * circuitos establecidos. En primer lugar, recibe la información del cliente, y
 * la envía hacia el servidor origen. En segundo lugar, envía las respuestas de
 * este último devuelta al cliente. Además, se encarga de gestionar las
...
public final class WriteHandler implements Handler {
	...
	/*
	 ** Procesa el evento para el cual está subscripto. En este caso, el evento
	 * es de escritura del flujo de bytes.
	 */
	public void handle(SelectionKey key) {
		...
		try {
			...
			logger.error("Handle failed with code {}", Message.UNKNOWN, exception);
	...
	/*
	 ** En caso de que el 'attachment' posea información disponible para enviar
	 * (en el buffer 'inbound'), habilita el canal de escritura en el
	 * 'upstream'.
	 */
